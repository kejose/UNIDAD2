...
[[2. Tipos de Sistemas de Gestión de Bases de Datos]]

[[3. Roles dentro de un SGBD]]
...
## 5. Creación y gestión de roles

### 5.1 Sintaxis general

La creación de roles sigue esta estructura:
...
- **NOT IDENTIFIED**: el rol no requiere contraseña.  
- **IDENTIFIED BY**: el rol requiere contraseña.  
- **IDENTIFIED USING**: autenticación mediante un paquete.  
- **EXTERNALLY**: autenticación externa.  
- **GLOBALLY**: autenticación global.
...
GRANT SELECT, INSERT, UPDATE, DELETE ON tabla TO miPrimerRole;
...
Los perfiles permiten limitar los recursos que un usuario puede consumir.  
Si no se asigna un perfil específico, se utiliza uno por defecto sin restricciones.
...
Los perfiles se gestionan mediante:
...
## 7. Elementos funcionales de un SGBD

Los SGBD suelen dividirse en dos grandes componentes:

### 7.1 Gestor de almacenamiento

Funciones principales:

- Asignación y liberación de espacio en disco  
- Organización física de los datos  
- Mantenimiento de integridad y consistencia  
- Indexación, compresión y fragmentación  
- Gestión de transacciones y recuperación ante fallos  

### 7.2 Gestor de autorización e integridad

Responsable de:

- Definir y administrar permisos  
- Controlar accesos  
- Aplicar restricciones que garanticen la coherencia de los datos  
